 ...
 * @returns array of combined birth year and start working date as strings, separated by #
 * @example 
 * ["1979-12-02#2013-11-10", "2003-12-01#2021-11-09"]
 */

export function generateDates(amount: number, minAge: number, maxAge: number): string[] {
